...
void destroyList(PassengerNode*);
int listSize(PassengerNode*);
...
int main(int argc, char** argv) {
	...
	cout << "4. View Number of Reservations" << endl;
	...
	while (choice < 1 || choice > 3) {
		...
		case 4:
			cout << "There are currently " << listSize(head) << " reservations for this flight." << endl;
			break;
...
int listSize(PassengerNode* head) {
	int count = 0;
	PassengerNode* hold = head;
...
void destroyList(PassengerNode* head) {
